const changeUI = (data) => {
    console.log(data.home_shopping_viewer);


    if (data.home_shopping_viewer) {
        var list = document.querySelector('#widget_list');
        var homeShopping = document.querySelector('.home-shopping').closest('.p20');
        list.innerHTML = homeShopping.innerHTML + list.innerHTML;
    }
...
const fetchUserData = (userId) => {
    let url = `https://proxy.cors.sh/https://personalization.us-west-2.hightouch.com/v1/collections/odk/records/id/${userId}`;
