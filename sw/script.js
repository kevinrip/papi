const changeUI = (data) => {
    ...
    let experience = data.dress_promotion || data.owns_subaru_outback || data.sw_promotion;

    let headerSelector = '#papi_offer';
    // let priceSelector = '#papiprice';


    let header = document.querySelector(headerSelector);
    // let price = document.querySelector(priceSelector);


    switch (experience) {
        case true:
            header.innerHTML = "Earn 75,000 bonus points";
            // price.innerHTML = "7";
            break;
        default:
            header.innerHTML = "Earn 50,000 bonus points";
        // price.innerHTML = "8";
    }
}
